...
const Cart = ({cart,handleDelete,handleAdd,cook}) => {
    return (
        <div className="border  border-gray-300 shadow-xl rounded-xl mb-20">
            ...
            <div>
           {
            ...
            <div className="divider"></div>
            <div className="flex gap-16 ml-16 md:justify-around text-[#878787]">
                <p>Name</p>
                <p>Time</p>
                <p>Calories</p>
             ...
             <div className="divider mb-0"></div>
                  <div>
                      {
                       cook.map((item,index) =>( 
                        <div key={index} className="flex text-[14px] md:text-[18px]   bg-gray-200  p-5  justify-around text-[#878787]">
                            <p className="flex items-center font-semibold text-black">{index+1}</p>
                             <p className="w-8">{item.recipe_name}</p>
                        <p className="w-8">{item.preparing_time} min</p>
                        <p className="w-8">{item.calories} calories</p>
            ...
            <div className="flex justify-end gap-8 mt-9 mr-14 text-[#878787]">
                <h1>Total Time =</h1>
                <h1>Total Calories =</h1>
            </div>
            <div className="flex justify-end gap-20 mb-10 mr-14 text-[#878787]">
