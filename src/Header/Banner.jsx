const Banner = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className=" space-y-9">
     ...
     <button className="btn bg-[#0BE58A] hover:bg-[#32bb82] border-0 btn-primary text-black">Explore Now</button>
      <button className="btn hover:bg-[#32bb82] text-white btn-outline">Our Feedback</button>
     </div>
    </div>
  </div>
</div>
